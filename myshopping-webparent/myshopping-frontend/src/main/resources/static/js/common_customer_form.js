...
function loadStatesForCountry() {
	...
	url = contextPath + "settings/list_states_by_country/" + countryId;//lấy tất cả states thuộc về country này
	
	$.get(url, function(responseJSON) {
		dataListState.empty();//xóa tất cả thẻ option trong dataList
