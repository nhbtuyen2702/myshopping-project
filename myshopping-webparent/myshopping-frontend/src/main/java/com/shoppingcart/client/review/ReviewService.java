...
import com.shoppingcart.client.order.OrderDetailRepository;
...
public class ReviewService {
	...
	public Review save(Review review) {
		...
		Review savedReview = reviewRepo.save(review);//lưu review xuống db
		
		Integer productId = savedReview.getProduct().getId();		
		productRepo.updateReviewCountAndAverageRating(productId);//update lại tổng số các review(reviewCount) và trung bình cộng các reviews(averageRating)
