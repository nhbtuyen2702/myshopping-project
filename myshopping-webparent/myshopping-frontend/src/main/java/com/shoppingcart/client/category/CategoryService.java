package com.shoppingcart.client.category;
...
public class CategoryService {
	...
	public List<Category> getCategoryParents(Category child) {
		...
		while (parent != null) {
			listParents.add(0, parent);//chèn theo thứ tự parent của category đang chọn vào đầu
			parent = parent.getParent();
		}
		
		listParents.add(child);//chèn category đang chọn vào cuối
