...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("SITE_NAME", "Myshop", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("SITE_LOGO", "Myshop.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT", "Copyright (C) 2021 Myshop Ltd.", SettingCategory.GENERAL);
