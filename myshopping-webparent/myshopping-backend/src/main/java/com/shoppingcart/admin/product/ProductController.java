...
public class ProductController {
	...
	//đường dẫn mặc định của module products
	...
	public String listByPage(@PathVariable(name = "pageNum") int pageNum, Model model,
			...
			@Param("keyword") String keyword, @Param("categoryId") Integer categoryId) {//categoryId dùng để so sánh với allParentIDs
	...
	//khi nhấn vào update status product
	...
	//khi nhấn vào view detail product
