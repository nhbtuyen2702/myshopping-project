...
public class BrandController {
	...
	//đường dẫn mặc định của module brands
	...
	public String newBrand(Model model) {
		List<Category> listCategories = categoryService.listCategoriesUsedInForm();//lấy ra tất cả categories, chỉ cần load tất cả categories lên dropdown nên sẽ gọi phương thức listCategoriesUsedInForm()
