...
public class CustomerController {
	...
	//đường dẫn mặc định của module customers
	...
	//khi nhấn vào update status customer
	...
	//khi nhấn vào view detail customer
