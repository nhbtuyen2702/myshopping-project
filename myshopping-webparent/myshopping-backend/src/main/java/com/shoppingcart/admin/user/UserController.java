...
public class UserController {
	...
	//đường dẫn mặc định của module users
	...
	public String listByPage(@PathVariable(name = "pageNum") int pageNum, Model model,
		...
		Page<User> page = service.listByPage(pageNum, sortField, sortDir, keyword);//đối tượng Page<User> chứa các thông tin để phân trang
		...
		String reverseSortDir = sortDir.equals("asc") ? "desc" : "asc";//Ví dụ: nhấn sort trên cột firstName thì sẽ đảo ngược thứ tự tất cả users theo firstName
	...
	//khi nhấn vào update status user
