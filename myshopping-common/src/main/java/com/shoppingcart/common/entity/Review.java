...
public class Review extends IdBasedEntity {
	...
	@Transient
	private boolean upvotedByCurrentCustomer;//thuộc tính này dùng để lưu thumb up khi customer nhấn thumb up
	
	@Transient
	private boolean downvotedByCurrentCustomer;//thuộc tính này dùng để lưu thumb down khi customer nhấn thumb down
